...
// Parking: Describes a parking space that a vehicle can be parked in while charging.
type Parking struct {
	ID                    string            `json:"id" validate:"required,max=36"`
	PhysicalReference     *string           `json:"physical_reference,omitempty" validate:"omitempty,max=12"`
	VehicleTypes          []VehicleType     `json:"vehicle_types" validate:"required,min=1"`
	...
	ParkingSpaceLength    *decimal.Decimal  `json:"parking_space_length,omitempty"`
	ParkingSpaceWidth     *decimal.Decimal  `json:"parking_space_width,omitempty"`
	...
	TimeLimit             *decimal.Decimal  `json:"time_limit,omitempty"`
...
// EVSEParking: Reference to a parking place from an EVSE. New in OCPI 2.3.0.
type EVSEParking struct {
	ParkingID    string        `json:"parking_id" validate:"required,max=36"`
	EVSEPosition *EVSEPosition `json:"evse_position,omitempty"`
}

// ConnectorCapability: Functionalities that a Connector may or may not support.
...
// VehicleType: A categorization of vehicles to indicate which type of vehicles can use a certain EVSE.
...
// ParkingDirection: Indicates the direction in which parking occurs relative to the roadway on which vehicles approach the EVSE.
...
// EVSEPosition: The position of an EVSE relative to the EVSE's parking space.
...
const (
	...
	ConnectorTypeMcs                ConnectorType = "MCS"
	...
	ConnectorTypeSaeJ3400           ConnectorType = "SAE_J3400"
