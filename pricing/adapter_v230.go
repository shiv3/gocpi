...
func periodFromV230(period v230.ChargingPeriod) (Period, error) {
	out := Period{Start: period.StartDateTime}
	seen := make(map[v230.CdrDimensionType]struct{}, len(period.Dimensions))
